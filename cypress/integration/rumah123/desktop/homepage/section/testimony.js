describe('Desktop automation for section Testimony', function () {
  let data;
  beforeEach(function () {
  ...
  it('C68639 Testimoni section should displayed 3 cards from different users', function () {
    ...
    cy.getElement('hp-testimony-card-wrapper')
      .find('.ui-molecules-carousel-v2__slide')
  ...
  it('C68642 Card title should inform about user name', function () {
    ...
    for (let i = 0; i < 3; i++) {
      cy.getElement('hp-testimony-title')
        .eq(i)
        .and(() => {
  ...
  it('C68645 Text user roles should not be empty', function () {
    ...
    for (let i = 0; i < 3; i++) {
      cy.getElement('hp-testimony-roles')
        .eq(i)
        .and(() => {
  ...
  it('C68647 Testimony wording should not be empty', function () {
    ...
    for (let i = 0; i < 3; i++) {
      cy.getElement('hp-testimony-wording')
        .eq(i)
        .and(() => {
